...
func (val *K8sValidator) InitClient(k8sVersion string, strict bool, ignoreMissingSchemas bool, schemaLocations []string) {
	val.validationClient = newKubconformValidator(k8sVersion, ignoreMissingSchemas, strict, schemaLocations)
}
...
func newKubconformValidator(k8sVersion string, ignoreMissingSchemas bool, strict bool, schemaLocations []string) ValidationClient {
	v, _ := kubeconformValidator.New(schemaLocations, kubeconformValidator.Opts{Strict: strict, KubernetesVersion: k8sVersion, IgnoreMissingSchemas: ignoreMissingSchemas})
	return v
}
