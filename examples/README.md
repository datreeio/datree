...
2. Fork the [Datree project](https://github.com/datreeio/datree)
...
3. Clone the forked project to your local machine:
   ...
   * Click on the green code button.              <img width="391" style="float: right;" alt="Screen Shot 2021-11-07 at 11 45 07" src="https://user-images.githubusercontent.com/1208902/142754350-8aca5344-08a1-4a07-aa02-a1f9e15f08e3.png">                   
   * Choose the cloning method (HTTPS, SSH, CLI). 
   * Copy the link.
